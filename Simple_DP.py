...
def Lexico_DP(w,priority,T):
    ...
    priority_u = [[0 for i in range(num_columns)] for j in range(num_rows)]
    priority_v = [[0 for i in range(num_columns)] for j in range(num_rows)]
